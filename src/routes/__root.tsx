...
import { updateRootClass } from "../lib/reduced-motion";
  ...
  head: () => ({
    meta: [
      ...
      { title: "VIVEQ — See through deception." },
      {
        name: "description",
        content:
          "VIVEQ is a privacy-first AI fraud-protection concept. Explore the interactive prototype.",
      },
      { name: "author", content: "VIVEQ" },
      { property: "og:title", content: "VIVEQ — See through deception." },
      {
        property: "og:description",
        content: "Privacy-first AI protection against digital fraud. Interactive prototype.",
      },
